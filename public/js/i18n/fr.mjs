...
export default {
  ...
  tagLanVlanBody:     'Chaque port LAN devient un <strong>port trunk</strong> au lieu d\'un port d\'accès normal (non tagué/PVID) sur le VLAN LAN. Les ports trunk attendent que chaque appareil connecté soit compatible VLAN, comme un switch manageable ou un Linux/Mac avec un VLAN configuré sur son port Ethernet.',
  ...
  wiredBackhaulNote:  'Préférez le backhaul filaire au sans-fil dès que possible.',
