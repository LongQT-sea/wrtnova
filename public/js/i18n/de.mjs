...
export default {
  ...
  sshPasswordAuthHelp: 'Off lehnt Passwort-Logins vollstaendig ab; nur die Schluessel oben werden akzeptiert.',
  ...
  timeFormatHelp:     'Uhrzeitanzeige in LuCI. Wird unter OpenWrt 24 und aelter ignoriert.',
  hostnameHelp:       'Standard: WrtNova, im AP-Modus zusaetzlich der AP-Index.',
  timezoneHelp:       'Legt Zeitzone und Sommerzeitregeln der Systemuhr fest.',
