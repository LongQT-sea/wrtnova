...
export default {
  ...
  adguardRamNote:     'Auf Geräten mit weniger als 110 MB RAM überspringt <code>wrtnova.sh</code> die anfängliche AdGuard-Home-Einrichtung.',
  ...
  adgQueryLog:        'AdGuard-Home-Anfrageprotokoll',
  adgQueryLogHelp:    'DNS-Anfragen im Anfrageprotokoll von AdGuard Home aufzeichnen. Benötigt deutlich mehr RAM.',
  adgSafeSearch:      'Sichere Suche in AdGuard Home',
  adgSafeSearchHelp:  'Sichere Suche in folgenden Suchmaschinen erzwingen: Google, YouTube, Bing, DuckDuckGo, Ecosia, Yandex, Pixabay.',
