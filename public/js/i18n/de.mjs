...
export default {
  ...
  tagLanVlanBody:     'Jeder LAN-Port wird zu einem <strong>Trunk-Port</strong> statt zu einem normalen Access-Port (ungetaggt/PVID) im LAN-VLAN. Trunk-Ports setzen voraus, dass jedes angeschlossene Gerät VLAN-fähig ist, etwa ein Managed Switch oder ein Linux/Mac mit einem auf dem Ethernet-Port konfigurierten VLAN.',
  ...
  wiredBackhaulNote:  'Kabelgebundenes Backhaul dem WLAN vorziehen, wann immer möglich.',
  ...
  dot11r:             '802.11r',
  dot11rHelp:         'Fast Transition (schnelles Roaming)',
