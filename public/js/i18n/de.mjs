...
export default {
  ...
  stpNote:            'Verhindert Bridge-Schleifen bei gemischtem kabelgebundenem und drahtlosem Backhaul.',
  ...
  bandSuffixHelp:     '2G/5G/6G ans Ende jeder SSID anhängen. Dadurch kann das Band-Steering von <code>usteer</code> zwischen 2G/5G/6G nicht mehr funktionieren; Roaming zwischen APs im selben Band funktioniert weiterhin.',
  indexSuffix:        'AP-Index-Suffix hinzufügen',
  indexSuffixHelp:    'AP-Index an jede SSID anhängen (nur im AP-Modus). Dadurch können Fast Transition, Nachbarschaftsberichte und unterstütztes Roaming zwischen APs nicht mehr funktionieren.',
