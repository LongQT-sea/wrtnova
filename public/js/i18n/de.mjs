...
export default {
  ...
  enableMeshBackhaul2G: '2.4 GHz 802.11s Mesh-Backhaul aktivieren',
  wirelessMesh2g: '2.4-GHz-Mesh',
  mesh2gNote: 'Größere Reichweite als 5GHz, erfordert aber Optimierung für höheren Durchsatz.',
  batmanAdv: 'batman-adv',
  batmanAdvHelp: 'batman-adv-Routing zusätzlich zum 802.11s-Mesh verwenden',
  batmanAdvNote: 'Besseres Multi-Hop-Routing für reine WLAN-Meshes.',
  batmanAllVlan: 'Alle VLANs über Mesh',
  batmanAllVlanHelp: 'WAN-B und zusätzliche VLANs ebenfalls über batman-adv trunken',
  batmanAllVlanNote: 'Standardmäßig werden nur LAN/Gast/IoT/VPN/WAN-VLANs über bat0 getragen.',
  backhaulOnly: 'Nur Backhaul',
  disableAllAps: 'Alle Access-Point-(AP)-Schnittstellen abschalten',
  bridgeStp:          'STP aktivieren',
  enableStp:          'Spanning Tree Protocol für br-vlan aktivieren',
  ...
  timeFormatHelp:     'Uhrzeitanzeige in LuCI. Wird in OpenWrt 24 und älter ignoriert.',
  hostnameHelp:       'Standard: WrtNova, im AP-Modus zusätzlich der AP-Index.',
  timezoneHelp:       'Legt die Zeitzone und die Sommerzeitregeln der Systemuhr fest.',
  ...
  irqbalanceHelp:     'Empfohlen fuer Systeme mit ≥4 CPU-Kernen. Verteilt IRQs automatisch auf die CPU-Kerne. Einige Geraete benoetigen fuer die beste Leistung eine manuelle IRQ-Affinitaets-Abstimmung.',
  luciHttps:          'LuCI HTTPS',
  luciHttpsHelp:      'HTTP-zu-HTTPS-Weiterleitung fuer LuCI aktivieren',
  ntpServer:          'NTP-Server-IP',
  ntpServerHelp:      'Rohe IP-Adresse fuer einen NTP-Server als letzte Reserve.',
  customScript:       'Eigenes Skript',
  customScriptPh:     'Shell-Skript, das einmal nach Abschluss von WrtNova ausgefuehrt wird',
  useIrqbalance:      'Empfohlen fuer Systeme mit ≥4 CPU-Kernen.',
  ...
  enableMeshBackhaul2GDefault: '2.4 GHz 802.11s Mesh-Backhaul aktivieren (pro Knoten überschreibbar)',
