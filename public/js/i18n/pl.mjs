...
export default {
  ...
  tagLanVlanBody:     'Każdy port LAN staje się <strong>portem trunk</strong> zamiast zwykłym portem dostępowym (nietagowany/PVID) w VLAN LAN. Porty trunk wymagają, aby każde podłączone urządzenie obsługiwało VLAN, jak zarządzalny switch albo Linux/Mac z VLAN skonfigurowanym na porcie Ethernet.',
  ...
  wiredBackhaulNote:  'Preferuj przewodowy backhaul zamiast bezprzewodowego, gdy tylko to możliwe.',
  ...
  dot11r:             '802.11r',
  dot11rHelp:         'Szybkie przełączanie (szybki roaming)',
