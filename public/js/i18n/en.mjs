...
export default {
  ...
  tagLanVlanBody:     'Every LAN port becomes a <strong>trunk port</strong> instead of a normal access port (untagged/PVID) on the LAN VLAN. Trunk ports expect every connected device to be VLAN-aware, like a managed switch or a Linux/Mac with a VLAN configured on its Ethernet port.',
  ...
  wiredBackhaulNote:  'Prefer wired backhaul over wireless whenever feasible.',
