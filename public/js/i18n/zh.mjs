...
export default {
  ...
  bandSuffix:         '添加频段后缀',
  bandSuffixHelp:     '在每个 SSID 末尾添加 2G/5G/6G。这可能导致 <code>usteer</code> 在 2G/5G/6G 之间的频段引导失效；同频段的 AP 之间漫游仍然有效。',
  indexSuffix:        '添加 AP 索引后缀',
  indexSuffixHelp:    '在每个 SSID 后附加 AP 索引（仅 AP 模式）。这可能导致快速切换、邻居报告和 AP 之间的辅助漫游失效。',
