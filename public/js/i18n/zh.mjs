...
export default {
  ...
  enableMeshBackhaul2G: '启用 2.4 GHz 802.11s 网状回程',
  wirelessMesh2g: '2.4 GHz 网状',
  mesh2gNote: '覆盖比 5GHz 更广，但需要调优以获得更高吞吐量。',
  batmanAdv: 'batman-adv',
  batmanAdvHelp: '在 802.11s 网状网络之上使用 batman-adv 路由',
  batmanAdvNote: '为纯无线网状网络提供更好的多跳路由。',
  batmanAllVlan: '所有 VLAN 经网状网络',
  batmanAllVlanHelp: '同时将 WAN-B 和额外 VLAN 经 batman-adv 中继',
  batmanAllVlanNote: '默认仅 LAN/访客/IoT/VPN/WAN VLAN 经 bat0 传输。',
  backhaulOnly: '仅回程',
  disableAllAps: '关闭所有接入点 (AP) 接口',
  bridgeStp:          '启用 STP',
  ...
  timeFormat24:       '24 小时',
  timeFormat12:       '12 小时',
  timeFormatHelp:     'LuCI 时钟显示格式。OpenWrt 24 及更早版本会忽略此项。',
  hostnameHelp:       '默认为 WrtNova，AP 模式下会附加 AP 序号。',
  timezoneHelp:       '设置系统时钟的时区与夏令时规则。',
  networkSection:     '网络',
  ...
  tagLanVlanHelp:     '将所有 LAN 端口变为仅中继（trunk）端口',
  ...
  enableMeshBackhaul2GDefault: '启用 2.4 GHz 802.11s 网状回程（可按节点覆盖）',
