...
export default {
  ...
  tagLanVlanBody:     'Cada puerto LAN se convierte en un <strong>puerto troncal</strong> en lugar de un puerto de acceso normal (sin etiquetar/PVID) en la VLAN LAN. Los puertos troncales esperan que cada dispositivo conectado sea compatible con VLAN, como un switch gestionado o un Linux/Mac con una VLAN configurada en su puerto Ethernet.',
  ...
  wiredBackhaulNote:  'Prefiere el backhaul por cable al inalámbrico siempre que sea posible.',
  ...
  dot11r:             '802.11r',
  dot11rHelp:         'Transición rápida (roaming rápido)',
