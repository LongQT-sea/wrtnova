...
export const BASE_SCHEMA = /** @type {[string,string,(string|undefined)?,(string|undefined)?][]} */ ([
  ...
  ['DENSE_ENV', 'checkbox'], ['WIRELESS_MESH', 'checkbox'], ['WIRELESS_MESH_2G', 'checkbox'], ['BRIDGE_STP', 'checkbox'], ['BATMAN_ADV', 'checkbox'], ['AP_DISABLE', 'checkbox'],
  ...
  ['DNS_MODE', 'radio', undefined, 'https-dns-proxy'], ['ADGUARD_MAIN_DNS', 'checkbox'],
  ['ADG_QUERY_LOG', 'checkbox'], ['ADG_SAFE_SEARCH', 'checkbox'], ['BLOCK_DOT_DOQ', 'checkbox'],
