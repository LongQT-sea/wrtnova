...
const NET_SCHEMA = [['shared_version', 'select', 'shared-version'],
  ...
  function defaultConfig() {
    return {
      ...
      COUNTRY_CODE: '', DENSE_ENV: '', WIRELESS_MESH: '', WIRELESS_MESH_2G: '', BRIDGE_STP: '', BATMAN_ADV: '',
      MESH_ID: '', MESH_PASSWD: '',
      ...
      CHANNEL_2G: '', CHANNEL_5G: '', CHANNEL_5G_2: '', CHANNEL_6G: '', WIFI_LOG_LVL: '', DOT11KV: '1', DOT11R: '1', PSK_VLAN: '', BAND_SUFFIX: '', GUEST_ISOLATE: '',
