(function () {
  ...
  const locales = {
    en: {
      ...
      nodeName:           'Node name',
      apIndex:            'AP index',
      apIndexHelp:        'Last octet 2–254. LAN IP becomes 192.168.1.',
      ...
      viewSourceGithub:   'View wrtnova.sh on GitHub ↗',
      ...
      bridgeWanPort:      'Force bridge non-DSA WAN port',
      bridgeWanPortNote:  'By default, WrtNova avoids adding non-DSA WAN port to br-vlan due to performance penalty. This option forces the non-DSA WAN port into the br-vlan bridge.',
      wifi:               'WiFi',
    ...
    zh: {
      ...
      nodeName:           '节点名称',
      apIndex:            'AP 索引',
      apIndexHelp:        '末段 2–254。LAN IP 为 192.168.1.',
      ...
      viewSourceGithub:   '在 GitHub 上查看 wrtnova.sh ↗',
      ...
      bridgeWanPort:      '强制桥接非 DSA wan 端口',
      bridgeWanPortNote:  '默认情况下，WrtNova 会避免将非 DSA WAN 端口加入 br-vlan 以防止性能损耗。此选项强制将非 DSA WAN 端口加入 br-vlan 网桥。',
      wifi:               'WiFi',
      countryCode:        '国家代码',
    ...
    de: {
      ...
      nodeName:           'Knotenname',
      apIndex:            'AP-Index',
      apIndexHelp:        'Letztes Oktett 2–254. LAN-IP wird 192.168.1.',
      ...
      fleetBuilderLink:   'Fleet-Builder →',
      viewSourceGithub:   'wrtnova.sh auf GitHub ansehen ↗',
      ...
      bridgeWanPort:      'Nicht-DSA-wan-Port erzwungen überbrücken',
      bridgeWanPortNote:  'WrtNova vermeidet standardmäßig das Hinzufügen eines Nicht-DSA-WAN-Ports zu br-vlan aufgrund von Leistungseinbußen. Diese Option erzwingt das Hinzufügen des Nicht-DSA-WAN-Ports zur br-vlan-Bridge.',
      wifi:               'WiFi',
    ...
    ru: {
      ...
      nodeName:           'Имя узла',
      apIndex:            'Индекс AP',
      apIndexHelp:        'Последний октет 2–254. LAN IP будет 192.168.1.',
      ...
      viewSourceGithub:   'wrtnova.sh на GitHub ↗',
      ...
      bridgeWanPort:      'Принудительный мост non-DSA wan порта',
      bridgeWanPortNote:  'По умолчанию WrtNova избегает добавления не-DSA WAN-порта в br-vlan из-за потери производительности. Эта опция принудительно добавляет не-DSA WAN-порт в мост br-vlan.',
      wifi:               'WiFi',
    ...
    pl: {
      ...
      apIndex:            'Indeks AP',
      apIndexHelp:        'Ostatni oktet 2–254. LAN IP staje się 192.168.1.',
      ...
      viewSourceGithub:   'Zobacz wrtnova.sh na GitHub ↗',
      ...
      bridgeWanPort:      'Wymuś mostkowanie portu non-DSA wan',
      bridgeWanPortNote:  'Domyslnie WrtNova unika dodawania portu WAN bez DSA do br-vlan ze wzgledu na spadek wydajnosci. Ta opcja wymusza dodanie portu WAN bez DSA do mostu br-vlan.',
      wifi:               'WiFi',
    ...
    fr: {
      ...
      apIndex:            'Index AP',
      apIndexHelp:        "Dernier octet 2–254. L'IP LAN devient 192.168.1.",
      ...
      viewSourceGithub:   'Voir wrtnova.sh sur GitHub ↗',
      ...
      bridgeWanPort:      'Forcer le pontage du port wan non-DSA',
      bridgeWanPortNote:  'Par défaut, WrtNova évite d\'ajouter un port WAN non-DSA à br-vlan en raison de la pénalité de performance. Cette option force le port WAN non-DSA dans le pont br-vlan.',
      wifi:               'WiFi',
    ...
    es: {
      ...
      apIndex:            'Índice AP',
      apIndexHelp:        'Último octeto 2–254. La IP LAN se convierte en 192.168.1.',
      ...
      viewSourceGithub:   'Ver wrtnova.sh en GitHub ↗',
      ...
      bridgeWanPort:      'Forzar puente del puerto wan no-DSA',
      bridgeWanPortNote:  'De forma predeterminada, WrtNova evita agregar un puerto WAN no-DSA a br-vlan debido a la penalizacion de rendimiento. Esta opcion fuerza el puerto WAN no-DSA al puente br-vlan.',
      wifi:               'WiFi',
