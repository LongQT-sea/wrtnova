(function () {
  ...
  const locales = {
    en: {
      ...
      enableMeshBackhaulDefault: 'Enable 5GHz 802.11s Mesh Backhaul (default — overridable per node)',
    ...
    zh: {
      ...
      enableMeshBackhaulDefault: '启用 5GHz 802.11s 网状回程（默认——可按节点覆盖）',
    ...
    de: {
      ...
      enableMeshBackhaulDefault: '5GHz 802.11s Mesh-Backhaul aktivieren (Standard — pro Knoten überschreibbar)',
    ...
    ru: {
      ...
      enableMeshBackhaulDefault: 'Включить 5GHz 802.11s mesh backhaul (по умолчанию — переопределяется на узле)',
    ...
    pl: {
      ...
      enableMeshBackhaulDefault: 'Włącz backhaul 5GHz 802.11s mesh (domyślnie — nadpisywalne per węzeł)',
    ...
    fr: {
      ...
      enableMeshBackhaulDefault: 'Activer le backhaul mesh 5GHz 802.11s (par défaut — modifiable par nœud)',
    ...
    es: {
      ...
      enableMeshBackhaulDefault: 'Activar backhaul mesh 5GHz 802.11s (predeterminado — anulable por nodo)',
