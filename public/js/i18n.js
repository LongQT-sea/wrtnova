...
import { ui } from './ui-ns.mjs';
  ...
  const locales = {
    ...
    de: {
      ...
      httpsDnsProxyHelp:  'Leichtgewichtiger Werbeblocker + DoH-Upstream. Für ≥8 MB Flash / ≥64 MB RAM.',
      dnsNone:            'Keine',
      ...
      blockDoh:           'Öffentliche DoH-Server blockieren',
      blockDohHelp:       'Bekannte DNS-over-HTTPS-Resolver per banIP-Feed blockieren, damit Clients die Filterung nicht umgehen können.',
      firewall:           'Firewall',
      banipCountry:       'Länder blockieren',
      banipCountryPh:     'z. B. lk in cn',
      banipCountryHelp:   'WAN-Verkehr aus diesen Ländern per banIP verwerfen. ISO-Codes in Kleinbuchstaben, leerzeichengetrennt.',
    ...
    pl: {
      ...
      httpsDnsProxyHelp:  'Lekkie blokowanie reklam + upstream DoH. Dla ≥8 MB flash / ≥64 MB RAM.',
      dnsNone:            'Brak',
      ...
      blockDoh:           'Blokuj publiczne serwery DoH',
      ...
      banipCountry:       'Blokuj kraje',
      banipCountryPh:     'np. lk in cn',
      banipCountryHelp:   'Odrzucaj ruch WAN z tych krajów przez banIP. Kody ISO małymi literami, oddzielone spacją.',
    ...
    es: {
      ...
      httpsDnsProxyHelp:  'Bloqueo ligero de anuncios + upstream DoH. Para ≥8 MB flash / ≥64 MB RAM.',
      dnsNone:            'Ninguno',
      ...
      blockDoh:           'Bloquear servidores DoH publicos',
      ...
      banipCountry:       'Bloquear paises',
      banipCountryPh:     'p. ej. lk in cn',
      banipCountryHelp:   'Descartar el trafico WAN procedente de estos paises mediante banIP. Codigos ISO en minusculas, separados por espacios.',
