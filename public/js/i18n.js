(function () {
  ...
  const locales = {
    en: {
      ...
      nodeName:           'Node name',
      apIndex:            'AP index',
      apIndexHelp:        'Last octet 2–19. LAN IP becomes 192.168.1.',
    ...
    zh: {
      ...
      nodeName:           '节点名称',
      apIndex:            'AP 索引',
      apIndexHelp:        '末段 2–19。LAN IP 为 192.168.1.',
    ...
    de: {
      ...
      nodeName:           'Knotenname',
      apIndex:            'AP-Index',
      apIndexHelp:        'Letztes Oktett 2–19. LAN-IP wird 192.168.1.',
    ...
    ru: {
      ...
      nodeName:           'Имя узла',
      apIndex:            'Индекс AP',
      apIndexHelp:        'Последний октет 2–19. LAN IP будет 192.168.1.',
    ...
    pl: {
      ...
      apIndex:            'Indeks AP',
      apIndexHelp:        'Ostatni oktet 2–19. LAN IP staje się 192.168.1.',
    ...
    fr: {
      ...
      apIndex:            'Index AP',
      apIndexHelp:        "Dernier octet 2–19. L'IP LAN devient 192.168.1.",
    ...
    es: {
      ...
      apIndex:            'Índice AP',
      apIndexHelp:        'Último octeto 2–19. La IP LAN se convierte en 192.168.1.',
