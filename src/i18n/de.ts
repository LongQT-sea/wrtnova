// de. Typed Catalog: a missing or misspelled key is a compile error.
...
const de: Catalog = {
  ...
  batmanAdvHelp: 'Besseres Multi-Hop-Routing für reine WLAN-Meshes. Bei nur wenigen Hops oder gemischten kabelgebundenen und drahtlosen Verbindungen ist einfaches 802.11s mit STP besser.',
  ...
  backhaulOnly: 'Alle AP-Schnittstellen deaktivieren',
  disableAllAps: 'Für reine Router- oder Mesh-Backhaul-Knoten.',
  bridgeStp: 'STP (Spanning Tree Protocol) auf <code>br-vlan</code> aktivieren',
  stpNote: 'Verhindert Layer-2-Schleifen bei gemischtem kabelgebundenem und drahtlosem Backhaul.',
  nonCtAth10k: 'Nicht-CT ath10k verwenden',
  ...
  fixIfaceConflict: 'Beheben Sie den Konflikt der Schnittstellennamen vor dem Erstellen.',
  ...
  ifaceReserved: 'Schnittstellenname "{field}" ist von wrtnova.sh reserviert - wählen Sie einen anderen.',
  ifaceDup: 'Schnittstellenname "{field}" wird bereits von einem anderen Netzwerk verwendet.',
  prefixInvalid: 'IP-Präfix "{field}" muss zwei Oktette 0-255 sein, z. B. 192.168',
  countryInvalid: 'Ländercode "{field}" muss aus zwei Buchstaben bestehen, z. B. US oder DE',
  ...
  deviceMode: 'Modus',
  apModeHelp: 'Im Modus Zugangspunkt ist DHCP deaktiviert und das Gerät arbeitet als WLAN-Access-Point und Managed Switch.',
  ...
  sshPasswordAuth: 'SSH-Authentifizierung',
  sshPasswordAuthHelp: 'Nur Schlüssel lehnt die SSH-Anmeldung per Passwort ab. Die LuCI-Weboberfläche ist nicht betroffen.',
  sshAuthOn: 'Schlüssel + Passwort',
  sshAuthOff: 'Nur Schlüssel',
  timezone: 'Zeitzone',
  timeFormat: 'Zeitformat',
  timeFormatDefault: 'Standard',
  timeFormat24: '24-Stunden',
  timeFormat12: '12-Stunden',
  timeFormatHelp: 'Erfordert OpenWrt 25 oder neuer.',
  ...
  enableIotInternet: 'Internetzugang für das IoT-Netzwerk',
  ...
  ifaceDupWarn: '! Zwei Netzwerke verwenden denselben Schnittstellennamen, oder ein Name ist von wrtnova.sh reserviert - beheben Sie es vor dem Erstellen.',
  ...
  wiredBackhaulNote: 'Tipp: Kabelgebundenes Backhaul ist dem WLAN immer vorzuziehen, sofern machbar.',
  ...
  wifiPskVlanNote: 'Per-VLAN-PSK benötigt für jedes aktivierte Netzwerk ein eindeutiges Passwort, um Clients zu lenken. Funkmodule ohne AP/VLAN-Unterstützung fallen auf getrennte SSIDs zurück.',
  ...
  dot11rBuggyNote: 'Hinweis: Die meisten modernen Geräte unterstützen 802.11r, aber einige ältere oder günstige Geräte möglicherweise nicht. Wenn ein Gerät keine Verbindung herstellt, versuchen Sie, 802.11r zu deaktivieren. Für IoT-Geräte verwenden Sie den dedizierten Schalter <strong>IoT: 802.11r</strong>.',
  bandSuffix: 'Band-Suffix hinzufügen',
  bandSuffixHelp: '2G/5G/6G ans Ende jeder SSID anhängen. Dadurch kann das Band-Steering von <code>usteer</code> zwischen den Bändern nicht mehr funktionieren; Roaming zwischen APs im selben Band bleibt unberührt.',
  indexSuffix: 'AP-Index-Suffix hinzufügen',
  indexSuffixHelp: 'Hängt den AP-Index an jede SSID an (nur im AP-Modus). Dies kann dazu führen, dass 802.11r und 802.11k/v zwischen APs nicht mehr funktionieren.',
  pskVlan: 'PSK pro VLAN (Multi-PSK)',
  ...
  portFwdNote: 'Jede Zeile erstellt einen statischen DHCPv4-Lease und NAT-Portweiterleitung. Ports müssen eindeutig sein.',
  ...
  adguardRamNote: 'Auf Geräten mit weniger als 230 MB RAM überspringt <code>wrtnova.sh</code> die anfängliche AdGuard-Home-Einrichtung.',
  ...
  dnsNone: 'Keine',
  dnsNoneHelp: 'Nur einfaches dnsmasq. Keine Werbeblockierung, kein verschlüsseltes DNS, kleinster Platzbedarf.',
  ...
  ntpServerHelp: 'Rohe NTP-Server-IP, um die Uhr bei jedem Verbindungsaufbau einer WAN-Schnittstelle zu synchronisieren.',
  ...
  blockDotDoqHelp: 'Verhindert, dass Clients Werbeblockierung und Filterung über DoT/DoQ umgehen.',
  blockDoh: 'Öffentliche DNS-über-HTTPS-Server blockieren',
  blockDohHelp: 'Bekannte DNS-over-HTTPS-Resolver per banIP blockieren, damit Clients Werbeblockierung und Filterung schwerer umgehen können.',
  forceDns: 'DNS zum Router erzwingen',
  forceDnsHelp: 'Alle DNS-Anfragen auf Port 53 (TCP/UDP) von LAN-, Gast- und IoT-Clients auf das DNS dieses Routers umleiten. Clients, die auf 8.8.8.8 oder 1.1.1.1 zeigen, werden transparent vom Router bedient.',
  firewall: 'Firewall',
  ...
  banipMemoryNote: 'Jede aktivierte Sperrliste und jedes Land erhöht den Speicherverbrauch. Zu viele können den RAM schnell erschöpfen und den OOM-Killer auslösen.',
  ...
  deviceQuestion: 'Für welchen Router baust du?',
  deviceQuestionHelp: 'Wähle zuerst die Hardware - alle weiteren Einstellungen hängen davon ab.',
  changeDevice: 'Gerät wechseln',
  releaseFellBack: 'Für OpenWrt {from} ist noch keine Geräteliste veröffentlicht, daher wurde {to} verwendet.',
  sectionsNav: 'Bereiche',
  themeLabel: 'Design',
  langLabel: 'Sprache',
  checksumLabel: 'SHA-256',
  buildImages: 'Images',
  narrowSearch: 'Zu viele Treffer - tippe weiter, um einzugrenzen.',
  noMatches: 'Keine Treffer.',
  routerIpLabel: 'Router-IP',
  fixBeforeBuild: 'Bitte vor dem Bauen beheben.',
