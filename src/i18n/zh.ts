// zh. Typed Catalog: a missing or misspelled key is a compile error.
...
const zh: Catalog = {
  ...
  adguardRamNote: '在内存小于 230 MB 的设备上，<code>wrtnova.sh</code> 会跳过 AdGuard Home 的初始设置。',
  ...
  ssidLabel: '{name} SSID',
  wifiPassword: '密码',
  deviceQuestion: '要为哪台路由器构建？',
  deviceQuestionHelp: '先选择硬件，其余所有设置都取决于它。',
  changeDevice: '更换设备',
  releaseFellBack: 'OpenWrt {from} 尚未发布设备列表，因此改用 {to}。',
  sectionsNav: '分区',
  themeLabel: '主题',
  langLabel: '语言',
  checksumLabel: 'SHA-256',
  buildImages: '镜像',
  narrowSearch: '匹配过多 — 继续输入以缩小范围。',
  noMatches: '没有匹配项。',
  routerIpLabel: '路由器 IP',
  fixBeforeBuild: '构建前请先修正。',
  usernameLabel: '用户名',
  dnsEngine: 'DNS 引擎',
