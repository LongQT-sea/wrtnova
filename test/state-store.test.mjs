...
function rawAllOn() {
  return {
    ...
    LAN_VPN_BASE_PREFIX: '10.4', LAN_VPN_VLAN_ID: '15', LAN_VPN_SUBNET: '/24',
    ...
    LAN_VPN_WIFI_SSID: 'v', LAN_VPN_WIFI_PASSWD: 'wgpass12',
...
test('deriveConfig: parent-off blanks all children', () => {
  ...
  for (const k of ['GUEST_BASE_PREFIX', 'GUEST_VLAN_ID', 'GUEST_SUBNET',
    ...
    'LAN_VPN_BASE_PREFIX', 'LAN_VPN_VLAN_ID', 'LAN_VPN_SUBNET',
